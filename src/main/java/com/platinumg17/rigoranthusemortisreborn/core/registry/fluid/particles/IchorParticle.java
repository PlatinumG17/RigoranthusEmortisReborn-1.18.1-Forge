...
@OnlyIn(Dist.CLIENT)
public class IchorParticle extends TextureSheetParticle {
    ...
    public IchorParticle(ClientLevel world, double x, double y, double z, double motionX, double motionY, double motionZ) {
        super(world, x, y, z);
        this.xd = motionX;
        this.yd = motionY;
        this.zd = motionZ;
    ...
    public void render(VertexConsumer builder, Camera renderInfo, float p_225606_3_) {
        ...
        RenderSystem._setShaderTexture(0, RigoranthusEmortisReborn.rl("textures/particle/ichor_particle.png"));
    ...
    @Override
    public ParticleRenderType getRenderType() { return renderType; }
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            IchorParticle ichorParticle = new IchorParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
            Random random = new Random();
            float colorOffset = (random.nextFloat() * 0.20f);
            ichorParticle.setColor(0.05f + colorOffset, 0.05f, 0.05f);
            ichorParticle.setAlpha(1.0f);
            ichorParticle.pickSprite(this.spriteSet);
            return ichorParticle;
        }
    }
}