...
public class ColorCache {
    ...
    protected ColorCache(int color) {this.color = color;}
    public int get() {return this.color;}

    public float[] getFloatArray() {
        if (this.floatArray == null) {
            this.floatArray = REUtil.rgbIntToFloatArray(this.color);
        }
        return this.floatArray;
    }
    public static ColorCache make(int color) {return new ColorCache(color);}
    @Override public int hashCode() {return this.color;}
