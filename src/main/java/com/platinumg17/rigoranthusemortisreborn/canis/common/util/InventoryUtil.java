...
public class InventoryUtil {
    ...
    public static InteractionResult feedCanisFrom(AbstractCanisEntity canisIn, @Nullable Entity entity, IItemHandlerModifiable source) {
        for (int i = 0; i < source.getSlots(); i++) {
            ...
            if (foodHandler.isPresent()) {
                InteractionResult response = foodHandler.get().consume(canisIn, stack, entity);
