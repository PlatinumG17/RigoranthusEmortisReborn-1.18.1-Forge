...
public class CanisBeamRenderer<T extends Entity> extends EntityRenderer<T> {
    ...
    public CanisBeamRenderer(EntityRendererProvider.Context rendererManager, float scale, boolean fullBright) {
        super(rendererManager);
        this.itemRenderer = rendererManager.getItemRenderer();
        this.scale = scale;
        this.fullBright = fullBright;
    }

    public CanisBeamRenderer(EntityRendererProvider.Context renderManagerIn) {
