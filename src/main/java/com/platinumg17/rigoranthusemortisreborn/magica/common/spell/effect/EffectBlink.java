...
//        if(spellContext.castingTile instanceof ItemLikeResponder){
//            ItemStack scroll = ((ItemLikeResponder) spellContext.castingTile).getItem(new ItemStack(MagicItemsRegistry.warpScroll));
//            if(!scroll.isEmpty()){
