...
public class EntityAllyVex extends Vex implements IFollowingSummon, ISummon {
    ...
    public EntityAllyVex(EntityType<? extends Vex> entity, Level level) {
        super(ModEntities.ALLY_VEX, level);
    }
    ...
    class ChargeAttackGoal extends Goal {
         ...
         */
        public void stop() { EntityAllyVex.this.setIsCharging(false); }
