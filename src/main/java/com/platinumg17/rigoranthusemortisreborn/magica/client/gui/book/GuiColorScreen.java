...
//    public void init() {
//        super.init();
//        redW = (SliderButton)buildSlider(new TranslatableComponent("rigoranthusemortisreborn.color_gui.red_slider").getString(), s -> red, (settings, d) -> red = d).createButton(Minecraft.getInstance().options, bookLeft + 28, bookTop + 49, 100);
//        greenW = (SliderButton)buildSlider(new TranslatableComponent("rigoranthusemortisreborn.color_gui.green_slider").getString(), s -> green, (settings, d) -> green = d).createButton(Minecraft.getInstance().options, bookLeft + 28, bookTop + 89, 100);
//        blueW = (SliderButton)buildSlider(new TranslatableComponent("rigoranthusemortisreborn.color_gui.blue_slider").getString(), s -> blue, (settings, d) -> blue = d).createButton(Minecraft.getInstance().options, bookLeft + 28, bookTop + 129, 100);
...
//        int color = -8355712;
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.title").getString(), 51, 24,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.presets").getString(), 159, 24,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.default").getString(), 170, 46,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.purple").getString(), 170, 70,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.blue").getString(), 170, 94,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.red").getString(), 170, 118,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.green").getString(), 170, 142,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.yellow").getString(), 228, 46,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.white").getString(), 228, 70,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.orange").getString(), 228, 94,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.cyan").getString(), 228, 118,  color);
//        minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.color_gui.save").getString(), 67, 160,  color);
//        int xOffset = 10;
//    }
//
//    @Override
