...
//    public GuiSpellBook(RigoranthusEmortisRebornAPI api, CompoundTag tag, int tier, String unlockedSpells) {
//        super();
//        this.api = api;
...
//                88, 12, null, new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.spell_name"));
...
//                54, 12, null, new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.search"));
...
//            spell_name.setSuggestion(new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.spell_name").getString());
//
//        if(searchBar.getValue().isEmpty())
//            searchBar.setSuggestion(new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.search").getString());
...
//                .withTooltip(this, new TranslatableComponent("rigoranthusemortisreborn.gui.notebook")));
...
//                .withTooltip(this, new TranslatableComponent("rigoranthusemortisreborn.gui.color")));
...
//                .withTooltip(this, new TranslatableComponent("rigoranthusemortisreborn.gui.familiar")));
...
//    }
//
//    public static void open(RigoranthusEmortisRebornAPI api, CompoundTag spell_book_tag, int tier, String unlockedSpells){
//        Minecraft.getInstance().setScreen(new GuiSpellBook(api, spell_book_tag, tier, unlockedSpells));
//    }
//
//    public void drawBackgroundElements(PoseStack stack, int mouseX, int mouseY, float partialTicks) {
//        super.drawBackgroundElements(stack, mouseX, mouseY, partialTicks);
//        minecraft.font.draw(stack,new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.form").getString(), 20, 24, -8355712);
//        minecraft.font.draw(stack,new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.effect").getString(), 154, 24, -8355712);
//        minecraft.font.draw(stack,new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.augment").getString(), 20, 78, -8355712);
...
//        if (validationErrors.isEmpty()) {
//            minecraft.font.draw(stack, new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.create"), 233, 183, -8355712);
//        } else {
//            // Color code chosen to match GL11.glColor4f(1.0F, 0.7F, 0.7F, 1.0F);
//            Component textComponent = new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.create")
...
//        }
//        minecraft.font.draw(stack,new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.clear").getString(), 177, 183, -8355712);
//    }
//
//    /**
...
//        spell_name.setSuggestion(spell_name.getValue().isEmpty() ? new TranslatableComponent("rigoranthusemortisreborn.spell_book_gui.spell_name").getString() : "");
//    }
//}