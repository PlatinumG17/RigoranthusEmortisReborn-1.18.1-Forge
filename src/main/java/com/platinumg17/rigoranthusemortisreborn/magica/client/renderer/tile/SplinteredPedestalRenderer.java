...
public class SplinteredPedestalRenderer implements BlockEntityRenderer<SplinteredPedestalTile> {

    public SplinteredPedestalRenderer(BlockEntityRendererProvider.Context renderManager) { }


    public void renderFloatingItem(SplinteredPedestalTile tileEntityIn, ItemEntity entityItem, double x, double y, double z, PoseStack stack, MultiBufferSource iRenderTypeBuffer){
        stack.pushPose();
    ...
    @Override
    public void render(SplinteredPedestalTile tileEntityIn, float v, PoseStack matrixStack, MultiBufferSource iRenderTypeBuffer, int i, int i1) {
