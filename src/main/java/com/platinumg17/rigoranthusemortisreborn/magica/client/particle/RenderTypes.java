...
public class RenderTypes {
    ...
    public static class ModClientEvents {
        ...
        public static void shaderRegistry(RegisterShadersEvent event) throws IOException
        {
            ...
            event.registerShader(new ShaderInstance(event.getResourceManager(), new ResourceLocation("rigoranthusemortisreborn:re_particle"), DefaultVertexFormat.PARTICLE), shaderInstance -> {
    ...
    public static class CustomRenderTypes extends RenderType
    {
        ...
        private static RenderType brightSolid(ResourceLocation locationIn)
        {
            ...
            return create("rigoranthusemortisreborn_re_particle", DefaultVertexFormat.PARTICLE, VertexFormat.Mode.QUADS, 256, true, false, rendertype$state);
        }
    }
}