...
public abstract class AbstractSpellPart implements Comparable<AbstractSpellPart> {
    ...
    public abstract int getDefaultDominionCost();

    public int getConfigCost(){
        return COST == null ? getDefaultDominionCost() : COST.get();
    }
    ...
    public TranslatableComponent getBookDescLang(){
        return new TranslatableComponent("rigoranthusemortisreborn.glyph_desc." + getId());
    }
    ...
    public void buildConfig(ForgeConfigSpec.Builder builder){
        ...
        COST = builder.comment("Cost").defineInRange("cost", getDefaultDominionCost(), Integer.MIN_VALUE, Integer.MAX_VALUE);
    ...
    public String getLocalizationKey() {
        return "rigoranthusemortisreborn.glyph_name." + id;
    }
