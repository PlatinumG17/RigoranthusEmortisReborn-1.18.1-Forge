...
public class SpellStats {
    ...
    public List<Component> addTooltip(List<Component> components){
        if(this.damageModifier != 0.0d)
            components.add(new TranslatableComponent("tooltip.rigoranthusemortisreborn.spell_damage", this.damageModifier).setStyle(Style.EMPTY.withColor(ChatFormatting.BLUE)));
        if(this.durationMultiplier != 0.0d)
            components.add(new TranslatableComponent("tooltip.rigoranthusemortisreborn.duration_modifier", this.durationMultiplier).setStyle(Style.EMPTY.withColor(ChatFormatting.GREEN)));
        if(this.amplification != 0.0d)
            components.add(new TranslatableComponent("tooltip.rigoranthusemortisreborn.amp_modifier", this.amplification).setStyle(Style.EMPTY.withColor(ChatFormatting.RED)));
